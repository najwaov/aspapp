<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paggee.aspx.cs" Inherits="aspapp.paggee" %>
                        ...
                        <ItemTemplate>
                            <table class="auto-style1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Image ID="Image1" runat="server" Height="132px" ImageUrl='<%# Eval("photo") %>' Width="123px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
